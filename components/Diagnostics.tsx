...
const features = [
  ...
  {
    icon: "speed",
    title: "قياس عزم السيارة (التسارع)",
    description:
      "قِس زمن التسارع من 0 إلى 100 كم/س وعزم سيارتك الفعلي، وقارن النتائج بعد كل تعديل أو صيانة.",
  },
];
      ...
      <div className="relative max-w-[1200px] mx-auto px-6 py-16 md:py-[88px] grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-14 items-center">
        <div>
          ...
          <p className="text-ink-muted leading-[1.8] text-base text-pretty mb-8">
            ...
            يراقب الحساسات لحظياً، يتابع استهلاك الوقود، ويقيس عزم سيارتك
            وتسارعها — كل شيء من نفس القطعة ونفس التطبيق.
          </p>
